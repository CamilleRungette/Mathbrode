...
<div className="row footer" >
    ...
    <Navbar expand="sm" style={{fontFamily:"Raleway", width: "100%" , margin:"auto", backgroundColor:"rgba(0, 0, 0, 0.8)"}}>
        <div style={{color:"white", textAlign:"center", margin:"auto", paddingTop:'1em'}}>
            ...
            <a href="https://www.instagram.com/mathbrode/?hl=fr"  target="_blank" rel="noopener noreferrer" ><img src="/logo-instagram-blanc.png" className="instagram" style={{height:"4em", width:'4em', color:'white'}} alt="Instagram logo" /></a>             
